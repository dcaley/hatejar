// Generated by dart2js (fast startup emitter, strong), the Dart to JavaScript compiler version: 2.10.0-110.3.beta.
...
(function dartProgram() {
  ...
  H = {JS_CONST: function JS_CONST() {
    ...
    stringReplaceAllFuncUnchecked: function(receiver, pattern, onMatch, onNonMatch) {
      ...
      for (t1 = pattern.allMatches$1(0, receiver), t1 = new H._AllMatchesIterator(t1._re, t1._string, t1._start), startIndex = 0, t2 = ""; t1.moveNext$0();) {
  ...
  P = {
    ...
    _BufferingStreamSubscription$: function(onData, onError, onDone, cancelOnError, $T) {
      ...
      return new P._BufferingStreamSubscription(t3, t4, type$.void_Function._as(t5), t1, t2, $T._eval$1("_BufferingStreamSubscription<0>"));
    },
    ...
    _SyncBroadcastStreamController: function _SyncBroadcastStreamController(t0, t1) {
      var _ = this;
      _.onCancel = t0;
      _._state = 0;
    ...
    LinkedHashMap_LinkedHashMap$from: function(other, $K, $V) {
      ...
      other._map.forEach$1(0, other.$ti._eval$1("~(1,2)")._as(new P.LinkedHashMap_LinkedHashMap$from_closure(result, $K, $V)));
      return result;
    },
    ...
    _BigIntImpl__BigIntImpl$_fromDouble: function(value) {
      var bits, i, exponent, unshiftedDigits, t1, t2, t3, unshiftedBig, absResult;
    ...
    _Uri__checkWindowsPathReservedCharacters: function(segments, argumentError, firstSegment) {
      ...
      for (t1 = H.SubListIterable$(segments, firstSegment, null, H._arrayInstanceType(segments)._precomputed1), t1 = new H.ListIterator(t1, t1.get$length(t1), t1.$ti._eval$1("ListIterator<ListIterable.E>")); t1.moveNext$0();) {
        ...
        if (J.contains$1$asx(cur, P.RegExp_RegExp('["*/:<>?\\\\|]'))) {
    ...
    ByteData_ByteData$view: function(buffer) {
      return H.NativeByteData_NativeByteData$view(buffer, 0, null);
    },
  ...
  U = {DefaultEquality: function DefaultEquality(t0) {
    ...
    ASN1Parser_parse: function(bytes) {
      var end, t3, obj, t1 = {},
        t2 = new U.ASN1Parser_parse_invalidFormat(),
        data = H.NativeByteData_NativeByteData$view(bytes.buffer, 0, null);
      t1.offset = 0;
      end = bytes.length;
      t3 = new U.ASN1Parser_parse_checkNBytesAvailable(t1, end, t2);
      obj = new U.ASN1Parser_parse_decodeObject(t1, t3, bytes, new U.ASN1Parser_parse_readEncodedLength(t1, t3, data), new U.ASN1Parser_parse_readBytes(t1, t3, bytes), new U.ASN1Parser_parse_readNullBytes(t1, t3, data, t2), end, t2).call$0();
      if (t1.offset !== end)
        throw H.wrapException(P.ArgumentError$("More bytes than expected in ASN1 encoding."));
      return obj;
    },
    ASN1Parser_parse_invalidFormat: function ASN1Parser_parse_invalidFormat() {
    },
    ASN1Parser_parse_checkNBytesAvailable: function ASN1Parser_parse_checkNBytesAvailable(t0, t1, t2) {
      this._box_0 = t0;
      this.end = t1;
      this.invalidFormat = t2;
    },
    ASN1Parser_parse_readBytes: function ASN1Parser_parse_readBytes(t0, t1, t2) {
      this._box_0 = t0;
      this.checkNBytesAvailable = t1;
      this.bytes = t2;
    },
    ASN1Parser_parse_readEncodedLength: function ASN1Parser_parse_readEncodedLength(t0, t1, t2) {
      this._box_0 = t0;
      this.checkNBytesAvailable = t1;
      this.data = t2;
    },
    ASN1Parser_parse_readNullBytes: function ASN1Parser_parse_readNullBytes(t0, t1, t2, t3) {
      var _ = this;
      _._box_0 = t0;
      _.checkNBytesAvailable = t1;
      _.data = t2;
      _.invalidFormat = t3;
    },
    ASN1Parser_parse_decodeObject: function ASN1Parser_parse_decodeObject(t0, t1, t2, t3, t4, t5, t6, t7) {
      var _ = this;
      _._box_0 = t0;
      _.checkNBytesAvailable = t1;
      _.bytes = t2;
      _.readEncodedLength = t3;
      _.readBytes = t4;
      _.readNullBytes = t5;
      _.end = t6;
      _.invalidFormat = t7;
    ...
    ASN1ObjectIdentifier: function ASN1ObjectIdentifier() {
    },
    ASN1Null: function ASN1Null() {
    },
    ...
    Highlighter$: function(span, color) {
      ...
      return new U.Highlighter(t1, t2, null, 1 + Math.max(t3.length, t4), new H.MappedListIterable(t1, t5._eval$1("int(1)")._as(new U.Highlighter$__closure()), t5._eval$1("MappedListIterable<1,int>")).reduce$1(0, H.instantiate1(P.math__max$closure(), type$.int)), !B.isAllTheSame(new H.WhereTypeIterable(new H.MappedListIterable(t1, t5._eval$1("Uri?(1)")._as(new U.Highlighter$__closure0()), t5._eval$1("MappedListIterable<1,Uri?>")), type$.WhereTypeIterable_Uri)), new P.StringBuffer(""));
    },
  ...
  B = {Pair: function Pair(t0, t1, t2) {
    ...
    authenticatedClient: function(baseClient, credentials) {
      if (credentials.accessToken.type !== "Bearer")
        throw H.wrapException(P.ArgumentError$("Only Bearer access tokens are accepted."));
      return new O.AuthenticatedClient(credentials, baseClient, false);
    },
    AccessToken: function AccessToken(t0, t1, t2) {
      this.type = t0;
      this.data = t1;
      this.expiry = t2;
    },
    AccessCredentials: function AccessCredentials(t0, t1) {
      this.accessToken = t0;
      this.scopes = t1;
    },
    ClientId: function ClientId(t0) {
      this.identifier = t0;
    },
    ServiceAccountCredentials: function ServiceAccountCredentials(t0, t1, t2, t3) {
      var _ = this;
      _.email = t0;
      _.clientId = t1;
      _.impersonatedUser = t2;
      _.privateRSAKey = t3;
    },
    AccessDeniedException: function AccessDeniedException(t0) {
      this.message = t0;
    },
    InternalStyle: function InternalStyle() {
    },
    getColumnLetter: function(index) {
      var number, remainder, t1, label;
      B.check("index", index);
      number = index - 1;
      remainder = C.JSInt_methods.$mod(number, 26);
      t1 = $.$get$_char_a();
      if (typeof t1 !== "number")
        return t1.$add();
      label = H.Primitives_stringFromCharCode(t1 + remainder);
      number = C.JSInt_methods._tdivFast$1(number, 26);
      for (; number > 0;) {
        label = H.Primitives_stringFromCharCode(t1 + (C.JSInt_methods.$mod(number, 26) - 1)) + label;
        number = C.JSInt_methods._tdivFast$1(number, 26);
      }
      return label;
    },
    check: function($name, value) {
      if (value < 1)
        throw H.wrapException(Y.GSheetsException$("invalid " + $name + " (" + value + ")"));
    },
    ...
    checkResponse: function(response) {
      ...
      if (response.statusCode !== 200) {
        t1 = J.$index$asx(C.C_JsonCodec.decode$2$reviver(B.encodingForCharset(U._contentTypeForHeaders(response.headers).parameters._map.$index(0, "charset")).decode$1(response.bodyBytes), null), "error");
        msg = J.$index$asx(t1 == null ? C.Map_empty : t1, "message");
        throw H.wrapException(Y.GSheetsException$(H._asStringS(msg == null ? response.get$body(response) : msg)));
      }
    },
    gridSheetsFilter: function(json) {
      return J.$eq$(J.$index$asx(J.$index$asx(json, "properties"), "sheetType"), "GRID");
    },
  ...
  R = {
    _convert: function(bytes, start, end) {
      ...
      for (t1 = buffer.length, t2 = J.getInterceptor$asx(bytes), i = start, bufferIndex = 0, byteOr = 0; i < end; ++i) {
    ...
    _HexEncoderSink: function _HexEncoderSink(t0) {
      this._encoder$_sink = t0;
    },
  ...
  G = {HashSink: function HashSink() {
    }, JwtFlow: function JwtFlow(t0, t1, t2, t3, t4) {
      var _ = this;
      _._clientEmail = t0;
      _._signer = t1;
      _._scopes = t2;
      _._user = t3;
      _._jwt$_client = t4;
    }, JwtFlow_run_jwtHeader: function JwtFlow_run_jwtHeader() {
    }, JwtFlow_run_jwtClaimSet: function JwtFlow_run_jwtClaimSet(t0, t1) {
      this.$this = t0;
      this.timestamp = t1;
  ...
  V = {
    _Sha256Sink$: function(sink) {
      var t1 = new Uint32Array(H._ensureNativeList(H.setRuntimeTypeInfo([1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225], type$.JSArray_legacy_int))),
        t2 = new Uint32Array(64),
        t3 = new Uint8Array(0);
      return new V._Sha256Sink(t1, t2, sink, new Uint32Array(16), new E.Uint8Buffer(t3, t3.length));
    },
  ...
  D = {
    clientViaServiceAccount: function(clientCredentials, scopes) {
      var baseClient = null;
      return D.clientViaServiceAccount$body(clientCredentials, scopes);
    },
    clientViaServiceAccount$body: function(clientCredentials, scopes) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.legacy_AutoRefreshingAuthClient),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], flow, credentials, t1, exception, t2, t3, baseClient, $async$exception;
      var $async$clientViaServiceAccount = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$currentError = $async$result;
          $async$goto = $async$handler;
        }
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              baseClient = null;
              if (baseClient == null)
                baseClient = new O.BrowserClient(P.LinkedHashSet_LinkedHashSet$_empty(type$.legacy_HttpRequest));
              else {
                t1 = baseClient;
                baseClient = new Z.RefCountedClient(2, t1, true);
              }
              flow = new G.JwtFlow(clientCredentials.email, new Q.RS256Signer(clientCredentials.privateRSAKey), scopes, clientCredentials.impersonatedUser, baseClient);
              credentials = null;
              $async$handler = 4;
              $async$goto = 7;
              return P._asyncAwait(flow.run$0(), $async$clientViaServiceAccount);
            case 7:
              // returning from await.
            ...
            case 6:
              ...
              t1 = baseClient;
              t2 = credentials;
              t3 = new D._ServiceAccountClient(flow, t2, new P._SyncBroadcastStreamController(null, type$._SyncBroadcastStreamController_legacy_AccessCredentials), t1, true);
              t3.authClient = B.authenticatedClient(t1, t2);
      ...
      return P._asyncStartSync($async$clientViaServiceAccount, $async$completer);
    },
    _ServiceAccountClient: function _ServiceAccountClient(t0, t1, t2, t3, t4) {
      var _ = this;
      _.flow = t0;
      _.credentials = t1;
      _.authClient = null;
      _._credentialStreamController = t2;
      _.baseClient = t3;
      _.closeUnderlyingClient = t4;
      _._http_client_base$_isClosed = false;
    },
  ...
  O = {AuthenticatedClient: function AuthenticatedClient(t0, t1, t2) {
      var _ = this;
      _.credentials = t0;
      _.baseClient = t1;
      _.closeUnderlyingClient = t2;
      _._http_client_base$_isClosed = false;
    }, AutoRefreshDelegatingClient: function AutoRefreshDelegatingClient() {
  ...
  K = {
    _getBytesFromPEMString: function(pemString) {
      var t3, lines,
        t1 = P.LineSplitter_split(pemString),
        t2 = t1.$ti;
      t2 = H.MappedIterable_MappedIterable(t1, t2._eval$1("String*(Iterable.E)")._as(new K._getBytesFromPEMString_closure()), t2._eval$1("Iterable.E"), type$.legacy_String);
      t1 = H._instanceType(t2);
      t3 = t1._eval$1("WhereIterable<Iterable.E>");
      lines = P.List_List$from(new H.WhereIterable(t2, t1._eval$1("bool(Iterable.E)")._as(new K._getBytesFromPEMString_closure0()), t3), true, t3._eval$1("Iterable.E"));
      if (lines.length < 2 || !J.startsWith$1$s(C.JSArray_methods.get$first(lines), "-----BEGIN") || !J.startsWith$1$s(C.JSArray_methods.get$last(lines), "-----END"))
        throw H.wrapException(P.ArgumentError$("The given string does not have the correct begin/end markers expected in a PEM file."));
      return new Uint8Array(H._ensureNativeList(C.C_Base64Decoder.convert$1(C.JSArray_methods.join$1(C.JSArray_methods.sublist$2(lines, 1, lines.length - 1), ""))));
    },
    _extractRSAKeyFromDERBytes: function(bytes) {
      var asn, objects, string, error, t1, exception,
        privateKeyFromSequence = new K._extractRSAKeyFromDERBytes_privateKeyFromSequence();
      try {
        asn = U.ASN1Parser_parse(bytes);
        if (asn instanceof U.ASN1Sequence) {
          objects = asn.objects;
          if (J.get$length$asx(objects) === 3 && J.$index$asx(objects, 2) instanceof U.ASN1OctetString) {
            string = type$.legacy_ASN1OctetString._as(J.$index$asx(objects, 2));
            t1 = privateKeyFromSequence.call$1(type$.legacy_ASN1Sequence._as(U.ASN1Parser_parse(string.bytes)));
            return t1;
          }
        }
        t1 = privateKeyFromSequence.call$1(type$.legacy_ASN1Sequence._as(asn));
        return t1;
      } catch (exception) {
        error = H.unwrapException(exception);
        t1 = P.ArgumentError$("Error while extracting private key from DER bytes: " + H.S(error));
        throw H.wrapException(t1);
      }
    },
    _getBytesFromPEMString_closure: function _getBytesFromPEMString_closure() {
    },
    _getBytesFromPEMString_closure0: function _getBytesFromPEMString_closure0() {
    },
    _extractRSAKeyFromDERBytes_privateKeyFromSequence: function _extractRSAKeyFromDERBytes_privateKeyFromSequence() {
    },
    _extractRSAKeyFromDERBytes_privateKeyFromSequence_closure: function _extractRSAKeyFromDERBytes_privateKeyFromSequence_closure() {
    }
  },
  Z = {
    RSAAlgorithm__encryptInteger: function(key, x) {
      var t1 = key.p,
        xp = Z.RSAAlgorithm__modPow(x.$mod(0, t1), key.dmp1, t1),
        t2 = key.q,
        xq = Z.RSAAlgorithm__modPow(x.$mod(0, t2), key.dmq1, t2);
      for (; xp.compareTo$1(0, xq) < 0;)
        xp = xp.$add(0, t1);
      return xp.$sub(0, xq).$mul(0, key.coeff).$mod(0, t1).$mul(0, t2).$add(0, xq);
    },
    RSAAlgorithm__modPow: function(b, e, m) {
      var t1, r0,
        r = $.$get$_BigIntImpl_one();
      if (e.compareTo$1(0, r) < 0)
        return r;
      t1 = $.$get$_BigIntImpl_zero();
      if (b.compareTo$1(0, t1) < 0 || b.compareTo$1(0, m) > 0)
        b = b.$mod(0, m);
      for (r0 = r; e.compareTo$1(0, t1) > 0;) {
        if (e.$and(0, r).compareTo$1(0, t1) > 0)
          r0 = r0.$mul(0, b).$mod(0, m);
        e = e.$shr(0, 1);
        b = b.$mul(0, b).$mod(0, m);
      }
      return r0;
    },
    RSAAlgorithm_bytes2BigInt: function(bytes) {
      var t1, i,
        number = $.$get$_BigIntImpl_zero();
      for (t1 = bytes.length, i = 0; i < t1; ++i)
        number = number.$shl(0, 8).$or(0, P._BigIntImpl__BigIntImpl$from(bytes[i]));
      return number;
    },
    RSAAlgorithm_integer2Bytes: function(integer, intendedLength) {
      var bytes, i;
      if (integer.compareTo$1(0, $.$get$_BigIntImpl_one()) < 0)
        throw H.wrapException(P.ArgumentError$("Only positive integers are supported."));
      bytes = new Uint8Array(intendedLength);
      for (i = bytes.length - 1; i >= 0; --i) {
        bytes[i] = integer.$and(0, $.$get$_bigIntFF()).toInt$0(0);
        integer = integer.$shr(0, 8);
      }
      return bytes;
    },
    RSAPrivateKey: function RSAPrivateKey(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _.p = t0;
      _.q = t1;
      _.n = t2;
    ...
    RequestImpl$: function(method, url, stream) {
      var t1 = type$.legacy_String;
      return new Z.RequestImpl(stream, method, url, P.LinkedHashMap_LinkedHashMap(new G.BaseRequest_closure(), new G.BaseRequest_closure0(), t1, t1));
    },
    DelegatingClient: function DelegatingClient() {
    },
    RefCountedClient: function RefCountedClient(t0, t1, t2) {
      var _ = this;
      _._refCount = t0;
      _.baseClient = t1;
      _.closeUnderlyingClient = t2;
    ...
    RequestImpl: function RequestImpl(t0, t1, t2, t3) {
      var _ = this;
      _._http_client_base$_stream = t0;
      _.method = t1;
      _.url = t2;
      _.headers = t3;
      _._finalized = false;
  ...
  Q = {RS256Signer: function RS256Signer(t0) {
      this._rsaKey = t0;
    }},
  Y = {
    GSheetsException$: function(cause) {
      return new Y.GSheetsException(cause);
    },
    GSheets__parseRenderOption: function(option) {
      switch (option) {
        case C.ValueRenderOption_0:
          return "FORMATTED_VALUE";
        case C.ValueRenderOption_2:
          return "FORMULA";
        default:
          return "UNFORMATTED_VALUE";
      }
    },
    GSheets__parseInputOption: function(option) {
      switch (option) {
        case C.ValueInputOption_0:
          return "USER_ENTERED";
        default:
          return "RAW";
      }
    },
    GSheets_batchUpdate: function(client, spreadsheetId, requests) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.legacy_Response),
        $async$returnValue, t1, t2, response;
      var $async$GSheets_batchUpdate = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return P._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = string$.https_s + spreadsheetId + ":batchUpdate";
              t2 = C.C_JsonCodec.encode$2$toEncodable(P.LinkedHashMap_LinkedHashMap$_literal(["requests", requests], type$.legacy_String, type$.legacy_List_legacy_Map_of_legacy_String_and_dynamic), null);
              $async$goto = 3;
              return P._asyncAwait(client._sendUnstreamed$5("POST", t1, type$.legacy_Map_of_legacy_String_and_legacy_String._as(null), t2, null), $async$GSheets_batchUpdate);
            case 3:
              // returning from await.
              response = $async$result;
              B.checkResponse(response);
      ...
      return P._asyncStartSync($async$GSheets_batchUpdate, $async$completer);
    },
    GSheetsException: function GSheetsException(t0) {
      this.cause = t0;
    },
    GSheets: function GSheets(t0) {
      this._client = null;
      this._credentials = t0;
    },
    GSheets_spreadsheet_closure: function GSheets_spreadsheet_closure(t0) {
      this.$this = t0;
    },
    GSheets_spreadsheet_closure0: function GSheets_spreadsheet_closure0(t0, t1, t2, t3) {
      var _ = this;
      _.client = t0;
      _.spreadsheetId = t1;
      _.renderOption = t2;
    ...
    ValueRenderOption: function ValueRenderOption(t0) {
      this._gsheets$_name = t0;
    },
    ValueInputOption: function ValueInputOption() {
    },
    Spreadsheet: function Spreadsheet(t0) {
      this.sheets = t0;
    },
    Spreadsheet_worksheetByTitle_closure: function Spreadsheet_worksheetByTitle_closure(t0) {
      this.title = t0;
    },
    Spreadsheet_worksheetByTitle_closure0: function Spreadsheet_worksheetByTitle_closure0() {
    },
    Worksheet: function Worksheet(t0, t1, t2, t3, t4, t5, t6, t7) {
      var _ = this;
      _._client = t0;
      _.spreadsheetId = t1;
      _.id = t2;
      _.renderOption = t3;
      _._title = t4;
      _._gsheets$_index = t5;
      _._values = null;
      _._rowCount = t6;
      _._columnCount = t7;
    },
    WorksheetAsValues: function WorksheetAsValues(t0) {
      this._ws = t0;
    },
  ...
  S = {
    main: function() {
      var $async$goto = 0,
        ...
        $async$returnValue, t1, identifier, privateKey, email, type, t2, gsheets, sheet, json;
  ...
  var holders = [C, H, J, P, W, M, U, B, N, R, A, G, V, D, O, K, Z, Q, Y, E, T, X, F, L, S];
  ...
  P._StreamImpl.prototype = {
    listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
      ...
      _this._isUsed = true;
      subscription = P._BufferingStreamSubscription$(onData, onError, onDone, cancelOnError === true, t1._precomputed1);
  ...
  P._BoundSinkStream.prototype = {
    listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
      ...
      subscription = new P._SinkTransformerStreamSubscription(t5, t6, type$.void_Function._as(t7), t3, t4, t2._eval$1("_SinkTransformerStreamSubscription<1,2>"));
  ...
  P._UnicodeSubsetEncoder.prototype = {
    ...
    startChunkedConversion$1: function(sink) {
      ...
      return new P._UnicodeSubsetEncoderSink(new P._ByteAdapterSink(sink), this._subsetMask);
    }
  };
  ...
  P._UnicodeSubsetEncoderSink.prototype = {
    ...
    addSlice$4: function(source, start, end, isLast) {
      ...
      t1 = new H.CodeUnits(source);
      listLength = t1.get$length(t1);
      P.RangeError_checkValidRange(start, end, listLength);
      t2 = this._sink._sink;
      t2.add$1(0, type$.List_int._as(P.List_List$from(t1.getRange$2(t1, start, end), true, type$.CodeUnits._eval$1("ListMixin.E"))));
      if (isLast)
        t2.close$0();
    }
  };
  ...
  P.AsciiDecoder.prototype = {
    startChunkedConversion$1: function(sink) {
      var stringSink = new P._StringAdapterSink(type$.Sink_String._as(sink));
      if (this._allowInvalid)
        return new P._ErrorHandlingAsciiDecoderSink(new P._Utf8ConversionSink(new P._Utf8Decoder(false), stringSink, new P.StringBuffer("")));
      else
  ...
  P._ErrorHandlingAsciiDecoderSink.prototype = {
    ...
    addSlice$4: function(source, start, end, isLast) {
      ...
      P.RangeError_checkValidRange(start, end, t2.get$length(source));
      for (t3 = this._utf8Sink, i = start; i < end; ++i) {
        t4 = t2.$index(source, i);
        if (typeof t4 !== "number")
          return t4.$and();
        if ((t4 & 4294967168) >>> 0 !== 0) {
          if (i > start)
            t3.addSlice$4(source, start, i, false);
          t1._as(C.List_239_191_189);
          t3.addSlice$4(C.List_239_191_189, 0, C.List_239_191_189.length, false);
          start = i + 1;
        }
      }
      if (start < end)
        t3.addSlice$4(source, start, end, false);
    }
  };
  P._SimpleAsciiDecoderSink.prototype = {
    close$0: function() {
      var t1 = this._sink._sink._async$_sink;
      if ((t1._state & 2) !== 0)
        H.throwExpression(P.StateError$("Stream is already closed"));
      t1.super$_BufferingStreamSubscription$_close();
    },
    add$1: function(_, source) {
      ...
      t1 = this._sink._sink;
      t2 = t1._async$_sink;
      t1 = t2.$ti._rest[1]._as(t1.$ti._precomputed1._as(P.String_String$fromCharCodes(source, 0, null)));
      if ((t2._state & 2) !== 0)
        H.throwExpression(P.StateError$("Stream is already closed"));
    ...
    normalize$3: function(source, start, end) {
      ...
      for (i = start, sliceStart = i, buffer = null, firstPadding = -1, firstPaddingSourceIndex = -1, paddingCount = 0; i < end; i = i0) {
        ...
        if (0 <= char0 && char0 <= 127) {
          ...
          if (value >= 0) {
            char0 = C.JSString_methods.codeUnitAt$1(string$.ABCDEFx2b, value);
            if (char0 === char)
              continue;
            char = char0;
          } else {
  ...
  P.Base64Encoder.prototype = {
    convert$1: function(input) {
      ...
      if (t1.get$isEmpty(input))
        return "";
      t2 = this._urlSafe ? string$.ABCDEFx2d : string$.ABCDEFx2b;
      t1 = new P._Base64Encoder(t2).encode$4(input, 0, t1.get$length(input), true);
      t1.toString;
      return P.String_String$fromCharCodes(t1, 0, null);
    },
    startChunkedConversion$1: function(sink) {
      type$.Sink_String._as(sink);
      return new P._AsciiBase64EncoderSink(sink, new P._BufferCachingBase64Encoder(this._urlSafe ? string$.ABCDEFx2d : string$.ABCDEFx2b));
    }
  };
  ...
  P._Base64EncoderSink.prototype = {
    ...
    close$0: function() {
      this._add$4(C.List_empty0, 0, 0, true);
    }
  };
  ...
  P.Base64Decoder.prototype = {
    ...
    startChunkedConversion$1: function(sink) {
      return new P._Base64DecoderSink(type$.Sink_List_int._as(sink), new P._Base64Decoder());
    }
  };
  ...
  P._Base64DecoderSink.prototype = {
    add$1: function(_, string) {
      ...
      if (buffer != null) {
        t1 = this._sink;
        t2 = t1._async$_sink;
        buffer = t2.$ti._rest[1]._as(t1.$ti._precomputed1._as(buffer));
        if ((t2._state & 2) !== 0)
          H.throwExpression(P.StateError$("Stream is already closed"));
    ...
    addSlice$4: function(string, start, end, isLast) {
      var t1, buffer, t2, t3,
        _s24_ = "Stream is already closed";
      P.RangeError_checkValidRange(start, end, string.length);
      if (start === end)
        return;
      t1 = this._decoder;
      ...
      if (buffer != null) {
        t2 = this._sink;
        t3 = t2._async$_sink;
        buffer = t3.$ti._rest[1]._as(t2.$ti._precomputed1._as(buffer));
        if ((t3._state & 2) !== 0)
          H.throwExpression(P.StateError$(_s24_));
        t3.super$_BufferingStreamSubscription$_add(buffer);
      }
      if (isLast) {
  ...
  P._Latin1DecoderSink.prototype = {
    ...
    _addSliceToSink$4: function(source, start, end, isLast) {
      ...
      t1 = t1._sink;
      t2 = t1._async$_sink;
      t1 = t2.$ti._rest[1]._as(t1.$ti._precomputed1._as(P.String_String$fromCharCodes(source, start, end)));
      if ((t2._state & 2) !== 0)
        H.throwExpression(P.StateError$("Stream is already closed"));
      t2.super$_BufferingStreamSubscription$_add(t1);
    },
      ...
      for (i = start; i < end; ++i) {
        ...
        if (char > 255 || char < 0) {
          if (i > start) {
            ...
            t3 = t3._sink;
            t4 = t3._async$_sink;
            t3 = t4.$ti._rest[1]._as(t3.$ti._precomputed1._as(P.String_String$fromCharCodes(source, start, i)));
            if ((t4._state & 2) !== 0)
              H.throwExpression(P.StateError$(_s24_));
          ...
          t3 = t3._sink;
          t4 = t3._async$_sink;
          t3 = t4.$ti._rest[1]._as(t3.$ti._precomputed1._as(P.String_String$fromCharCodes(C.List_65533, 0, 1)));
          if ((t4._state & 2) !== 0)
            H.throwExpression(P.StateError$(_s24_));
          t4.super$_BufferingStreamSubscription$_add(t3);
          start = i + 1;
  ...
  P._StringConversionSinkAsStringSinkAdapter.prototype = {
    writeCharCode$1: function(charCode) {
      var t1 = this._convert$_buffer._contents += H.Primitives_stringFromCharCode(charCode);
      if (t1.length > 16)
        this._flush$0();
    },
    write$1: function(o) {
  ...
  P._StringSinkConversionSink.prototype = {
    ...
    add$1: function(_, str) {
      this._stringSink._contents += H.S(H._asStringS(str));
    }
  };
  P._StringAdapterSink.prototype = {
    add$1: function(_, str) {
      var t1 = this._sink,
        t2 = t1._async$_sink;
      str = t2.$ti._rest[1]._as(t1.$ti._precomputed1._as(H._asStringS(str)));
      if ((t2._state & 2) !== 0)
        H.throwExpression(P.StateError$("Stream is already closed"));
    ...
    addSlice$4: function(str, start, end, isLast) {
      ...
      if (t1) {
        ...
        t1 = t2.$ti._rest[1]._as(t3._precomputed1._as(J.substring$2$s(str, start, end)));
        if ((t2._state & 2) !== 0)
          H.throwExpression(P.StateError$(_s24_));
        t2.super$_BufferingStreamSubscription$_add(t1);
      }
  ...
  P._Utf8ConversionSink.prototype = {
    ...
    addSlice$4: function(chunk, startIndex, endIndex, isLast) {
      var accumulated,
        t1 = this._convert$_buffer,
        t2 = t1._contents += this._decoder.convertGeneral$4(type$.List_int._as(chunk), startIndex, endIndex, false);
      if (t2.length !== 0) {
        accumulated = t2.charCodeAt(0) == 0 ? t2 : t2;
  ...
  P._Utf8EncoderSink.prototype = {
    ...
    addSlice$4: function(str, start, end, isLast) {
      var t1, t2, t3, t4, t5, t6, isLastSlice, t7, _this = this;
      ...
      do {
        ...
        if (start === t4 && (t5._codeUnitAt$1(str, start) & 64512) === 55296) {
          if (isLast && _this._bufferIndex < t6)
            _this._writeReplacementCharacter$0();
          else
            _this._carry = t5._codeUnitAt$1(str, start);
          ++start;
        }
        t7 = _this._bufferIndex;
        t1.add$1(0, C.NativeUint8List_methods.sublist$2(t3._as(t2), 0, t7));
        if (isLastSlice)
          t1.close$0();
        _this._bufferIndex = 0;
      } while (start < end);
  ...
  P.Utf8Decoder.prototype = {
    ...
    startChunkedConversion$1: function(sink) {
      type$.Sink_String._as(sink);
      return new P._Utf8ConversionSink(new P._Utf8Decoder(this._allowMalformed), new P._StringAdapterSink(sink), new P.StringBuffer(""));
    },
    bind$1: function(stream) {
  ...
  R.HexEncoder.prototype = {
    ...
    startChunkedConversion$1: function(sink) {
      return new R._HexEncoderSink(type$.legacy_Sink_legacy_String._as(sink));
    }
  };
  R._HexEncoderSink.prototype = {
    add$1: function(_, chunk) {
      ...
      t1 = this._encoder$_sink;
      t2 = t1._async$_sink;
      t1 = t2.$ti._rest[1]._as(t1.$ti._precomputed1._as(R._convert(chunk, 0, J.get$length$asx(chunk))));
      if ((t2._state & 2) !== 0)
        H.throwExpression(P.StateError$("Stream is already closed"));
      t2.super$_BufferingStreamSubscription$_add(t1);
    },
    close$0: function() {
      var t1 = this._encoder$_sink._async$_sink;
      if ((t1._state & 2) !== 0)
        H.throwExpression(P.StateError$("Stream is already closed"));
      t1.super$_BufferingStreamSubscription$_close();
    }
  ...
  B.Digest.prototype = {
    $eq: function(_, other) {
      var a, b, t1, t2, mismatch, i, t3;
      if (other == null)
        return false;
      if (other instanceof B.Digest) {
        a = this.bytes;
        b = other.bytes;
        t1 = a.length;
        t2 = b.length;
    ...
    get$hashCode: function(_) {
      return C.C_ListEquality.hash$1(this.bytes);
    },
    toString$0: function(_) {
      var t1 = type$.HexCodec._eval$1("Codec.S")._as(this.bytes);
  ...
  A.Hash.prototype = {
    convert$1: function(data) {
      ...
      innerSink = new R.DigestSink();
      t1 = V._Sha256Sink$(type$.legacy_Sink_legacy_Digest._as(innerSink));
      t1.add$1(0, type$.List_int._as(data));
      t1.close$0();
      return innerSink._digest_sink$_value;
    }
  };
  G.HashSink.prototype = {
    add$1: function(_, data) {
      var _this = this;
      type$.legacy_List_legacy_int._as(data);
      if (_this._isClosed)
        throw H.wrapException(P.StateError$("Hash.add() called after close()."));
    ...
    close$0: function() {
      ...
      t1.add$1(0, new B.Digest(_this._byteDigest$0()));
      t1.close$0();
    },
    _byteDigest$0: function() {
      var cachedDigest, t1, byteDigest, byteData, i;
      if (C.C_Endian === $.$get$Endian_host())
        return H.NativeUint8List_NativeUint8List$view(this._digest.buffer, 0, null);
      ...
      byteData = H.NativeByteData_NativeByteData$view(byteDigest.buffer, 0, null);
      for (t1 = cachedDigest.length, i = 0; i < t1; ++i)
        C.NativeByteData_methods._setUint32$3(byteData, i * 4, cachedDigest[i], false);
      return byteDigest;
    },
    _iterate$0: function() {
      var pendingDataChunks, i, j,
        t1 = this._pendingData,
        pendingDataBytes = H.NativeByteData_NativeByteData$view(t1._typed_buffer$_buffer.buffer, 0, null),
      ...
      for (t2 = t3.length, i = 0; i < pendingDataChunks; ++i) {
        for (j = 0; j < t2; ++j) {
          t4 = t3.byteLength;
          if (typeof t4 !== "number")
            return H.iae(t4);
          t3[j] = C.NativeByteData_methods._getUint32$2(pendingDataBytes, i * t4 + j * 4, false);
        }
      ...
      if (typeof t2 !== "number")
        return H.iae(t2);
      t2 = pendingDataChunks * t2;
      P.RangeError_checkValidRange(0, t2, t1.get$length(t1));
      if (t2 > 0)
    ...
    _finalizeData$0: function() {
      var contentsLength, t3, i, lengthInBits, offset, byteData, _this = this,
        ...
        t2 = H._instanceType(t1)._eval$1("TypedDataBuffer.E");
      ...
      if (t2 > 1125899906842623)
        throw H.wrapException(P.UnsupportedError$("Hashing is unsupported for messages with more than 2^53 bits."));
      lengthInBits = t2 * 8;
      offset = t1._typed_buffer$_length;
      t1.addAll$1(0, new Uint8Array(8));
      byteData = H.NativeByteData_NativeByteData$view(t1._typed_buffer$_buffer.buffer, 0, null);
      C.NativeByteData_methods._setUint32$3(byteData, offset, C.JSInt_methods._shrOtherPositive$1(lengthInBits, 32), false);
      C.NativeByteData_methods._setUint32$3(byteData, offset + 4, (lengthInBits & 4294967295) >>> 0, false);
    },
    $isSink: 1
  };
  V.Sha256.prototype = {
    startChunkedConversion$1: function(sink) {
      var t1, t2, t3;
      type$.legacy_Sink_legacy_Digest._as(sink);
      t1 = new Uint32Array(H._ensureNativeList(H.setRuntimeTypeInfo([1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225], type$.JSArray_legacy_int)));
      t2 = new Uint32Array(64);
      t3 = new Uint8Array(0);
      return new P._ByteAdapterSink(new V._Sha256Sink(t1, t2, sink, new Uint32Array(16), new E.Uint8Buffer(t3, t3.length)));
    }
  };
  V._Sha32BitSink.prototype = {
  ...
  B.AccessToken.prototype = {
    toString$0: function(_) {
      return "AccessToken(type=" + H.S(this.type) + ", data=" + this.data + ", expiry=" + this.expiry.toString$0(0) + ")";
    }
  };
  B.AccessCredentials.prototype = {};
  B.ClientId.prototype = {};
  B.ServiceAccountCredentials.prototype = {};
  B.AccessDeniedException.prototype = {
    toString$0: function(_) {
      return this.message;
    },
    $isException: 1
  };
  D._ServiceAccountClient.prototype = {
    send$1: function(_, request) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.legacy_StreamedResponse),
        $async$returnValue, $async$self = this, newCredentials, t1;
      var $async$send$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.credentials.accessToken;
              $async$goto = new P.DateTime(Date.now(), false).toUtc$0()._value <= t1.expiry._value ? 3 : 5;
              break;
            case 3:
              // then
              $async$returnValue = $async$self.authClient.send$1(0, request);
              // goto return
              $async$goto = 1;
              break;
              // goto join
            ...
            case 5:
              // else
              $async$goto = 6;
              return P._asyncAwait($async$self.flow.run$0(), $async$send$1);
            case 6:
              // returning from await.
              newCredentials = $async$result;
              $async$self._credentialStreamController.add$1(0, newCredentials);
              $async$self.credentials = newCredentials;
              t1 = B.authenticatedClient($async$self.baseClient, newCredentials);
              $async$self.authClient = t1;
              $async$returnValue = t1.send$1(0, request);
              // goto return
              $async$goto = 1;
              break;
            case 4:
  ...
  O.AuthenticatedClient.prototype = {
    send$1: function(_, request) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.legacy_StreamedResponse),
        $async$returnValue, $async$self = this, modifiedRequest, t1, response, wwwAuthenticate;
      var $async$send$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return P._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              modifiedRequest = Z.RequestImpl$(request.method, request.url, new Z.ByteStream(P.Stream_Stream$fromIterable(H.setRuntimeTypeInfo([request._bodyBytes], type$.JSArray_legacy_List_legacy_int), type$.legacy_List_legacy_int)));
              t1 = modifiedRequest.headers;
              t1.addAll$1(0, request.headers);
              t1.$indexSet(0, "Authorization", "Bearer " + $async$self.credentials.accessToken.data);
              $async$goto = 3;
              return P._asyncAwait($async$self.baseClient.send$1(0, modifiedRequest), $async$send$1);
            case 3:
              // returning from await.
              response = $async$result;
              wwwAuthenticate = response.headers.$index(0, "www-authenticate");
              $async$goto = wwwAuthenticate != null ? 4 : 5;
              break;
            case 4:
              // then
              t1 = response.stream;
              $async$goto = 6;
              return P._asyncAwait(t1.listen$2$cancelOnError(null, true).asFuture$1$1(null, type$.dynamic), $async$send$1);
            case 6:
              // returning from await.
              throw H.wrapException(new B.AccessDeniedException("Access was denied (www-authenticate header was: " + wwwAuthenticate + ")."));
            case 5:
              // join
              $async$returnValue = response;
              // goto return
  ...
  O.AutoRefreshDelegatingClient.prototype = {$isAutoRefreshingAuthClient: 1};
  U.ASN1Parser_parse_invalidFormat.prototype = {
    call$1: function(msg) {
      throw H.wrapException(P.ArgumentError$("Invalid DER encoding: " + msg));
    },
    $signature: 30
  };
  U.ASN1Parser_parse_checkNBytesAvailable.prototype = {
    call$1: function(n) {
      if (this._box_0.offset + n > this.end)
        this.invalidFormat.call$1("Tried to read more bytes than available.");
    },
    $signature: 31
  };
  U.ASN1Parser_parse_readBytes.prototype = {
    call$1: function(n) {
      var t1, t2, integerBytes;
      this.checkNBytesAvailable.call$1(n);
      t1 = this._box_0;
      t2 = t1.offset;
      integerBytes = C.NativeUint8List_methods.sublist$2(this.bytes, t2, t2 + n);
      t1.offset += n;
      return integerBytes;
    },
    $signature: 32
  };
  U.ASN1Parser_parse_readEncodedLength.prototype = {
    call$0: function() {
      var t2, t3, lengthByte, countLengthBytes, $length,
        t1 = this.checkNBytesAvailable;
      t1.call$1(1);
      t2 = this.data;
      t3 = this._box_0;
      lengthByte = t2.getUint8(t3.offset++);
      if (typeof lengthByte !== "number")
        return lengthByte.$lt();
      if (lengthByte < 128)
        return lengthByte;
      countLengthBytes = lengthByte & 127;
      t1.call$1(countLengthBytes);
      for ($length = 0; countLengthBytes > 0;) {
        t1 = t2.getUint8(t3.offset++);
        if (typeof t1 !== "number")
          return H.iae(t1);
        $length = ($length << 8 | t1) >>> 0;
        --countLengthBytes;
      }
      return $length;
    },
  ...
  U.ASN1Parser_parse_readNullBytes.prototype = {
    call$0: function() {
      var nullByte, _this = this;
      _this.checkNBytesAvailable.call$1(1);
      nullByte = _this.data.getUint8(_this._box_0.offset++);
      if (nullByte !== 0)
        _this.invalidFormat.call$1("Null byte expect, but was: " + H.S(nullByte) + ".");
    },
    $signature: 1
  };
  U.ASN1Parser_parse_decodeObject.prototype = {
    call$0: function() {
      var t1, t2, t3, tag, lengthInBytes, endOfSequence, objects, _this = this;
      _this.checkNBytesAvailable.call$1(1);
      t1 = _this.bytes;
      t2 = _this._box_0;
      t3 = t2.offset++;
      ...
      switch (tag) {
        case 2:
          return new U.ASN1Integer(Z.RSAAlgorithm_bytes2BigInt(_this.readBytes.call$1(_this.readEncodedLength.call$0())));
        case 4:
          return new U.ASN1OctetString(_this.readBytes.call$1(_this.readEncodedLength.call$0()));
        case 5:
          _this.readNullBytes.call$0();
          return new U.ASN1Null();
        case 6:
          _this.readBytes.call$1(_this.readEncodedLength.call$0());
          return new U.ASN1ObjectIdentifier();
        case 48:
          lengthInBytes = _this.readEncodedLength.call$0();
          t1 = t2.offset;
          if (typeof lengthInBytes !== "number")
            return H.iae(lengthInBytes);
          if (t1 + lengthInBytes > _this.end)
            _this.invalidFormat.call$1("Tried to read more bytes than available.");
          endOfSequence = t2.offset + lengthInBytes;
          objects = H.setRuntimeTypeInfo([], type$.JSArray_legacy_ASN1Object);
          for (; t2.offset < endOfSequence;)
            C.JSArray_methods.add$1(objects, _this.call$0());
          return new U.ASN1Sequence(objects);
        default:
          _this.invalidFormat.call$1("Unexpected tag " + tag + " at offset " + (t2.offset - 1) + " (end: " + _this.end + ").");
      }
      return null;
    },
    $signature: 34
  };
  U.ASN1Object.prototype = {};
  U.ASN1Sequence.prototype = {};
  U.ASN1Integer.prototype = {};
  U.ASN1OctetString.prototype = {};
  U.ASN1ObjectIdentifier.prototype = {};
  U.ASN1Null.prototype = {};
  K._getBytesFromPEMString_closure.prototype = {
    call$1: function(line) {
      return J.trim$0$s(H._asStringS(line));
    },
    $signature: 18
  };
  K._getBytesFromPEMString_closure0.prototype = {
    call$1: function(line) {
      return H._asStringS(line).length !== 0;
    },
    $signature: 19
  };
  K._extractRSAKeyFromDERBytes_privateKeyFromSequence.prototype = {
    call$1: function(asnSequence) {
      var t4, t5, t6, bitLength,
        objects = asnSequence.objects,
        t1 = H.SubListIterable$(objects, 0, 9, H._arrayInstanceType(objects)._precomputed1),
        t2 = t1.$ti,
        t3 = t2._eval$1("MappedListIterable<ListIterable.E,ASN1Integer*>"),
        asnIntegers = P.List_List$from(new H.MappedListIterable(t1, t2._eval$1("ASN1Integer*(ListIterable.E)")._as(new K._extractRSAKeyFromDERBytes_privateKeyFromSequence_closure()), t3), true, t3._eval$1("ListIterable.E"));
      t1 = C.JSArray_methods.get$first(asnIntegers).integer;
      if (!J.$eq$(t1, $.$get$_BigIntImpl_zero()))
        throw H.wrapException(P.ArgumentError$("Expected version 0, got: " + H.S(t1) + "."));
      t1 = asnIntegers.length;
      if (1 >= t1)
        return H.ioore(asnIntegers, 1);
      t2 = asnIntegers[1].integer;
      if (2 >= t1)
        return H.ioore(asnIntegers, 2);
      asnIntegers[2].toString;
      if (3 >= t1)
        return H.ioore(asnIntegers, 3);
      asnIntegers[3].toString;
      if (4 >= t1)
        return H.ioore(asnIntegers, 4);
      t3 = asnIntegers[4].integer;
      if (5 >= t1)
        return H.ioore(asnIntegers, 5);
      t4 = asnIntegers[5].integer;
      if (6 >= t1)
        return H.ioore(asnIntegers, 6);
      t5 = asnIntegers[6].integer;
      if (7 >= t1)
        return H.ioore(asnIntegers, 7);
      t6 = asnIntegers[7].integer;
      if (8 >= t1)
        return H.ioore(asnIntegers, 8);
      t1 = asnIntegers[8].integer;
      bitLength = t2.get$bitLength(t2);
      if (bitLength !== 1024 && bitLength !== 2048 && bitLength !== 4096)
        throw H.wrapException(P.ArgumentError$("The RSA modulus has a bit length of " + bitLength + ". Only 1024, 2048 and 4096 are supported."));
      return new Z.RSAPrivateKey(t3, t4, t2, t5, t6, t1);
    },
    $signature: 37
  };
  K._extractRSAKeyFromDERBytes_privateKeyFromSequence_closure.prototype = {
    call$1: function(o) {
      return type$.legacy_ASN1Integer._as(type$.legacy_ASN1Object._as(o));
    },
    $signature: 38
  };
  Z.RSAPrivateKey.prototype = {};
  Q.RS256Signer.prototype = {};
  Z.DelegatingClient.prototype = {
    close$0: function() {
      var _this = this;
      if (_this._http_client_base$_isClosed)
        throw H.wrapException(P.StateError$("Cannot close a HTTP client more than once."));
      _this._http_client_base$_isClosed = true;
      _this.super$BaseClient$close();
      if (_this.closeUnderlyingClient)
        _this.baseClient.close$0();
    }
  };
  Z.RefCountedClient.prototype = {
    send$1: function(_, request) {
    ...
    close$0: function() {
      ...
      _this._refCount = t1;
      if (t1 === 0)
        _this.super$DelegatingClient$close();
    },
    _ensureClientIsOpen$0: function() {
      ...
      if (typeof t1 !== "number")
        return t1.$le();
      if (t1 <= 0)
        throw H.wrapException(P.StateError$("This reference counted HTTP client has reached a count of zero and can no longer be used for making HTTP requests."));
    }
  };
  Z.RequestImpl.prototype = {
    finalize$0: function() {
      this.super$BaseRequest$finalize();
      return new Z.ByteStream(this._http_client_base$_stream);
    }
  };
  G.JwtFlow.prototype = {
    run$0: function() {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.legacy_AccessCredentials),
        $async$returnValue, $async$self = this, jwtHeaderBase64, jwtClaimSetBase64, jwtSignatureInput, t5, digestInfo, t6, modulusLen, block, signature, jwt, body, request, httpResponse, response, tokenType, token, expiresIn, error, t1, t2, t3, t4, $async$temp1;
      var $async$run$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = C.JSInt_methods._tdivFast$1(new P.DateTime(Date.now(), false).toUtc$0()._value, 1000);
              t2 = type$.legacy_List_legacy_int;
              t3 = type$.Base64Codec._eval$1("Codec.S");
              t4 = t3._as(t2._as(C.AsciiEncoder_127.convert$1(C.C_JsonCodec.encode$2$toEncodable(new G.JwtFlow_run_jwtHeader().call$0(), null))));
              t4 = C.Base64Codec_Base64Encoder_true.get$encoder().convert$1(t4);
              jwtHeaderBase64 = H.stringReplaceAllUnchecked(t4, "=", "");
              t4 = type$.Utf8Codec._eval$1("Codec.S");
              t1 = t4._as(C.C_JsonCodec.encode$2$toEncodable(new G.JwtFlow_run_jwtClaimSet($async$self, t1 - 20).call$0(), null));
              t1 = t3._as(t2._as(C.C_Utf8Codec.get$encoder().convert$1(t1)));
              t1 = C.Base64Codec_Base64Encoder_true.get$encoder().convert$1(t1);
              jwtClaimSetBase64 = H.stringReplaceAllUnchecked(t1, "=", "");
              jwtSignatureInput = jwtHeaderBase64 + "." + jwtClaimSetBase64;
              t1 = t2._as(C.AsciiEncoder_127.convert$1(jwtSignatureInput));
              t1 = $.$get$sha256().convert$1(t1).bytes;
              t5 = t1.length;
              digestInfo = new Uint8Array(19 + t5);
              t6 = digestInfo.length;
              if (0 >= t6) {
                $async$returnValue = H.ioore(digestInfo, 0);
                // goto return
                $async$goto = 1;
                break;
              }
              digestInfo[0] = 48;
              if (1 >= t6) {
                $async$returnValue = H.ioore(digestInfo, 1);
                // goto return
                $async$goto = 1;
                break;
              }
              digestInfo[1] = t6 - 2;
              if (2 >= t6) {
                $async$returnValue = H.ioore(digestInfo, 2);
                // goto return
                $async$goto = 1;
                break;
              }
              digestInfo[2] = 48;
              if (3 >= t6) {
                $async$returnValue = H.ioore(digestInfo, 3);
                // goto return
                $async$goto = 1;
                break;
              }
              digestInfo[3] = 13;
              C.NativeUint8List_methods.setAll$2(digestInfo, 4, C.List_2Vk0);
              if (15 >= t6) {
                $async$returnValue = H.ioore(digestInfo, 15);
                // goto return
                $async$goto = 1;
                break;
              }
              digestInfo[15] = 5;
              if (16 >= t6) {
                $async$returnValue = H.ioore(digestInfo, 16);
                // goto return
                $async$goto = 1;
                break;
              }
              digestInfo[16] = 0;
              if (17 >= t6) {
                $async$returnValue = H.ioore(digestInfo, 17);
                // goto return
                $async$goto = 1;
                break;
              }
              digestInfo[17] = 4;
              if (18 >= t6) {
                $async$returnValue = H.ioore(digestInfo, 18);
                // goto return
                $async$goto = 1;
                break;
              }
              digestInfo[18] = t5;
              C.NativeUint8List_methods.setAll$2(digestInfo, 19, t1);
              t1 = $async$self._signer._rsaKey;
              t5 = t1.n;
              modulusLen = C.JSInt_methods._tdivFast$1(t5.get$bitLength(t5) + 7, 8);
              block = new Uint8Array(modulusLen);
              t5 = block.length;
              if (0 >= t5) {
                $async$returnValue = H.ioore(block, 0);
                // goto return
                $async$goto = 1;
                break;
              }
              block[0] = 0;
              if (1 >= t5) {
                $async$returnValue = H.ioore(block, 1);
                // goto return
                $async$goto = 1;
                break;
              }
              block[1] = 1;
              t6 = 2 + (t5 - t6 - 3);
              C.NativeUint8List_methods.fillRange$3(block, 2, t6, 255);
              if (t6 < 0) {
                $async$returnValue = H.ioore(block, t6);
                // goto return
                $async$goto = 1;
                break;
              }
              block[t6] = 0;
              C.NativeUint8List_methods.setRange$3(block, t6 + 1, t5, digestInfo);
              signature = Z.RSAAlgorithm_integer2Bytes(Z.RSAAlgorithm__encryptInteger(t1, Z.RSAAlgorithm_bytes2BigInt(block)), modulusLen);
              t1 = jwtSignatureInput + ".";
              signature = t3._as(t2._as(signature));
              t3 = C.Base64Codec_Base64Encoder_true.get$encoder().convert$1(signature);
              jwt = t1 + H.stringReplaceAllUnchecked(t3, "=", "");
              t1 = t4._as("grant_type=" + H.S(P._Uri__uriEncode(C.List_KIf, "urn:ietf:params:oauth:grant-type:jwt-bearer", C.C_Utf8Codec, false)) + "&assertion=" + H.S(P._Uri__uriEncode(C.List_KIf, jwt, C.C_Utf8Codec, false)));
              body = P.Stream_Stream$fromIterable(H.setRuntimeTypeInfo([C.C_Utf8Codec.get$encoder().convert$1(t1)], type$.JSArray_legacy_List_legacy_int), t2);
              request = Z.RequestImpl$("POST", P.Uri_parse(string$.https_a), body);
              request.headers.$indexSet(0, "content-type", "application/x-www-form-urlencoded; charset=utf-8");
              $async$goto = 3;
              return P._asyncAwait($async$self._jwt$_client.send$1(0, request), $async$run$0);
            case 3:
              // returning from await.
              httpResponse = $async$result;
              t2 = httpResponse.stream;
              t1 = H._instanceType(t2)._eval$1("StreamTransformer<Stream.T,String*>")._as(C.Utf8Decoder_false).bind$1(t2);
              t1 = t1.$ti._eval$1("StreamTransformer<Stream.T,Object*>")._as(C.C_JsonCodec.get$decoder()).bind$1(t1);
              $async$temp1 = type$.legacy_Map_dynamic_dynamic;
              $async$goto = 4;
              return P._asyncAwait(t1.get$first(t1), $async$run$0);
            case 4:
              // returning from await.
              response = $async$temp1._as($async$result);
              tokenType = response.$index(0, "token_type");
              token = response.$index(0, "access_token");
              expiresIn = response.$index(0, "expires_in");
              error = response.$index(0, "error");
              if (httpResponse.statusCode !== 200 && error != null)
                throw H.wrapException(P.Exception_Exception("Unable to obtain credentials. Error: " + H.S(error) + "."));
              if (!J.$eq$(tokenType, "Bearer") || token == null || !H._isInt(expiresIn))
                throw H.wrapException(P.Exception_Exception("Unable to obtain credentials. Invalid response from server."));
              H._asStringS(tokenType);
              H._asStringS(token);
              t1 = new P.DateTime(Date.now(), false).toUtc$0();
              t1 = P.DateTime$_withValue(t1._value + C.JSInt_methods._tdivFast$1(1000000 * (expiresIn - 20), 1000), t1.isUtc);
              if (tokenType != null)
                t2 = false;
              else
                t2 = true;
              ...
              $async$returnValue = new B.AccessCredentials(new B.AccessToken(tokenType, token, t1), $async$self._scopes);
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  G.JwtFlow_run_jwtHeader.prototype = {
    call$0: function() {
      var t1 = type$.legacy_String;
      return P.LinkedHashMap_LinkedHashMap$_literal(["alg", "RS256", "typ", "JWT"], t1, t1);
    },
    $signature: 39
  };
  G.JwtFlow_run_jwtClaimSet.prototype = {
    call$0: function() {
      var t1 = this.$this,
        t2 = this.timestamp,
        claimSet = P.LinkedHashMap_LinkedHashMap$_literal(["iss", t1._clientEmail, "scope", C.JSArray_methods.join$1(t1._scopes, " "), "aud", string$.https_a, "exp", t2 + 3600, "iat", t2], type$.legacy_String, type$.legacy_Object);
      return claimSet;
    },
    $signature: 40
  };
  Y.GSheetsException.prototype = {
    toString$0: function(_) {
      return "GSheetsException: " + this.cause;
    },
    $isException: 1
  };
  Y.GSheets.prototype = {
    get$client: function(_) {
      ...
      if (_this._client == null)
        _this.set$_client(D.clientViaServiceAccount(_this._credentials, C.List_kqK));
      return _this._client;
    },
    spreadsheet$1: function(spreadsheetId) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.legacy_Spreadsheet),
        $async$returnValue, $async$self = this, t2, t3, result, client, response, renderOption, inputOption, t1, onError;
      var $async$spreadsheet$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return P._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.get$client($async$self);
              onError = new Y.GSheets_spreadsheet_closure($async$self);
              t1.toString;
              ...
              t1._addListener$1(new P._FutureListener(result, 2, null, onError, t2._eval$1("@<1>")._bind$1(t2._precomputed1)._eval$1("_FutureListener<1,2>")));
              $async$goto = 3;
              return P._asyncAwait(result, $async$spreadsheet$1);
            case 3:
              // returning from await.
              client = $async$result;
              t1 = string$.https_s + spreadsheetId;
              client.toString;
              $async$goto = 4;
              return P._asyncAwait(client._sendUnstreamed$3("GET", t1, type$.legacy_Map_of_legacy_String_and_legacy_String._as(null)), $async$spreadsheet$1);
            case 4:
              // returning from await.
              response = $async$result;
              B.checkResponse(response);
              renderOption = Y.GSheets__parseRenderOption(C.ValueRenderOption_1);
              inputOption = Y.GSheets__parseInputOption(C.ValueInputOption_0);
              t1 = J.where$1$ax(type$.legacy_List_dynamic._as(J.$index$asx(C.C_JsonCodec.decode$2$reviver(B.encodingForCharset(U._contentTypeForHeaders(response.headers).parameters._map.$index(0, "charset")).decode$1(response.bodyBytes), null), "sheets")), B.utils__gridSheetsFilter$closure());
              t2 = t1.$ti;
              t3 = t2._eval$1("MappedIterable<1,Worksheet*>");
              $async$returnValue = new Y.Spreadsheet(P.List_List$from(new H.MappedIterable(t1, t2._eval$1("Worksheet*(1)")._as(new Y.GSheets_spreadsheet_closure0(client, spreadsheetId, renderOption, inputOption)), t3), true, t3._eval$1("Iterable.E")));
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return P._asyncStartSync($async$spreadsheet$1, $async$completer);
    },
    set$_client: function(_client) {
      this._client = type$.legacy_Future_legacy_AutoRefreshingAuthClient._as(_client);
    }
  };
  Y.GSheets_spreadsheet_closure.prototype = {
    call$1: function(_) {
      var t1 = this.$this;
      t1.set$_client(null);
      return t1.get$client(t1);
    },
    $signature: 41
  };
  Y.GSheets_spreadsheet_closure0.prototype = {
    call$1: function(json) {
      var _s10_ = "properties",
        _s14_ = "gridProperties";
      type$.legacy_Map_of_legacy_String_and_dynamic._as(json);
      return new Y.Worksheet(this.client, this.spreadsheetId, H._asIntS(J.$index$asx(json.$index(0, _s10_), "sheetId")), this.renderOption, H._asStringS(J.$index$asx(json.$index(0, _s10_), "title")), H._asIntS(J.$index$asx(json.$index(0, _s10_), "index")), H._asIntS(J.$index$asx(J.$index$asx(json.$index(0, _s10_), _s14_), "rowCount")), H._asIntS(J.$index$asx(J.$index$asx(json.$index(0, _s10_), _s14_), "columnCount")));
    },
    $signature: 42
  };
  Y.ValueRenderOption.prototype = {
    toString$0: function(_) {
      return this._gsheets$_name;
    }
  };
  Y.ValueInputOption.prototype = {
    toString$0: function(_) {
      return "ValueInputOption.user_entered";
    }
  };
  Y.Spreadsheet.prototype = {
    worksheetByTitle$1: function(title) {
      return C.JSArray_methods.firstWhere$2$orElse(this.sheets, new Y.Spreadsheet_worksheetByTitle_closure(title), new Y.Spreadsheet_worksheetByTitle_closure0());
    }
  };
  Y.Spreadsheet_worksheetByTitle_closure.prototype = {
    call$1: function(sheet) {
      return type$.legacy_Worksheet._as(sheet)._title === this.title;
    },
    $signature: 43
  };
  Y.Spreadsheet_worksheetByTitle_closure0.prototype = {
    call$0: function() {
      return null;
    },
    $signature: 0
  };
  Y.Worksheet.prototype = {
    toString$0: function(_) {
      var _this = this;
      return "Worksheet{spreadsheetId: " + _this.spreadsheetId + ", id: " + H.S(_this.id) + ", title: " + H.S(_this._title) + ", index: " + H.S(_this._gsheets$_index) + ", rowCount: " + H.S(_this._rowCount) + ", columnCount: " + H.S(_this._columnCount) + "}";
    },
    _get$2: function(range, dimension) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.legacy_List_legacy_String),
        $async$returnValue, $async$self = this, t1, t2, list, encodedRange, response;
      var $async$_get$2 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return P._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              encodedRange = P._Uri__uriEncode(C.List_KIf, range, C.C_Utf8Codec, false);
              $async$goto = 3;
              return P._asyncAwait($async$self._client._sendUnstreamed$3("GET", string$.https_s + $async$self.spreadsheetId + "/values/" + H.S(encodedRange) + "?majorDimension=" + dimension + "&valueRenderOption=" + $async$self.renderOption, type$.legacy_Map_of_legacy_String_and_legacy_String._as(null)), $async$_get$2);
            case 3:
              // returning from await.
              response = $async$result;
              B.checkResponse(response);
              t1 = type$.legacy_List_dynamic;
              t2 = t1._as(J.$index$asx(C.C_JsonCodec.decode$2$reviver(B.encodingForCharset(U._contentTypeForHeaders(response.headers).parameters._map.$index(0, "charset")).decode$1(response.bodyBytes), null), "values"));
              list = t1._as(t2 == null ? null : J.get$first$ax(t2));
              t1 = list == null ? null : J.map$1$1$ax(list, B.utils__parseValue$closure(), type$.legacy_String);
              t1 = t1 == null ? null : t1.toList$0(0);
              $async$returnValue = t1 == null ? H.setRuntimeTypeInfo([], type$.JSArray_legacy_String) : t1;
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return P._asyncStartSync($async$_get$2, $async$completer);
    },
    _columnRange$3: function(column, row, $length) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.legacy_String),
        $async$returnValue, $async$self = this, t1, expand, label, to;
      var $async$_columnRange$3 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return P._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = row + $length - 1;
              expand = $async$self._expand$2(t1, column);
              label = B.getColumnLetter(column);
              to = $length > 0 ? "" + t1 : "";
              $async$goto = 3;
              return P._asyncAwait(expand, $async$_columnRange$3);
            case 3:
              // returning from await.
              $async$returnValue = "'" + H.S($async$self._title) + "'!" + label + row + ":" + label + to;
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return P._asyncStartSync($async$_columnRange$3, $async$completer);
    },
    _expand$2: function(rows, cols) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.legacy_bool),
        $async$returnValue, $async$self = this, changed, t2, t3, t4, t1, $async$temp1;
      var $async$_expand$2 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return P._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              if (t1 < rows) {
                t1 = $async$self._rowCount = rows;
                changed = true;
              } else
                changed = false;
              t2 = $async$self._columnCount;
              if (typeof t2 !== "number") {
              ...
              if (t2 < cols) {
                t2 = $async$self._columnCount = cols;
                changed = true;
              }
              $async$goto = changed ? 3 : 4;
              break;
            case 3:
              // then
              t3 = type$.legacy_String;
              t4 = type$.legacy_Object;
              $async$temp1 = B;
              $async$goto = 5;
              return P._asyncAwait(Y.GSheets_batchUpdate($async$self._client, $async$self.spreadsheetId, H.setRuntimeTypeInfo([P.LinkedHashMap_LinkedHashMap$_literal(["updateSheetProperties", P.LinkedHashMap_LinkedHashMap$_literal(["properties", P.LinkedHashMap_LinkedHashMap$_literal(["sheetId", $async$self.id, "gridProperties", P.LinkedHashMap_LinkedHashMap$_literal(["rowCount", t1, "columnCount", t2], t3, type$.legacy_int)], t3, t4), "fields", "gridProperties/rowCount,gridProperties/columnCount"], t3, t4)], t3, type$.dynamic)], type$.JSArray_legacy_Map_of_legacy_String_and_dynamic)), $async$_expand$2);
            case 5:
              // returning from await.
              $async$temp1.checkResponse($async$result);
            case 4:
              // join
              $async$returnValue = changed;
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return P._asyncStartSync($async$_expand$2, $async$completer);
    }
  };
  Y.WorksheetAsValues.prototype = {
    column$1: function(column) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.legacy_List_legacy_String),
        $async$returnValue, $async$self = this, t1, $async$temp1;
      var $async$column$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return P._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              B.check("column", column);
              B.check("fromRow", 1);
              t1 = $async$self._ws;
              $async$temp1 = t1;
              $async$goto = 3;
              return P._asyncAwait(t1._columnRange$3(column, 1, -1), $async$column$1);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1._get$2($async$result, "COLUMNS");
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return P._asyncStartSync($async$column$1, $async$completer);
    }
  };
  ...
  O.BrowserClient.prototype = {
    ...
    close$0: function() {
      for (var t1 = this._xhrs, t1 = P._LinkedHashSetIterator$(t1, t1._collection$_modifications, t1.$ti._precomputed1); t1.moveNext$0();)
  ...
  Z.ByteStream_toBytes_closure.prototype = {
    call$1: function(bytes) {
      return this.completer.complete$1(new Uint8Array(H._ensureNativeList(type$.legacy_List_legacy_int._as(bytes))));
    },
    $signature: 47
  };
  ...
  O.Request.prototype = {
    ...
    set$body: function(_, value) {
      var contentType, t2, _this = this,
        _s12_ = "content-type",
        t1 = type$.legacy_List_legacy_int._as(_this.get$encoding().encode$1(value));
    ...
    finalize$0: function() {
      this.super$BaseRequest$finalize();
      return new Z.ByteStream(P.Stream_Stream$fromIterable(H.setRuntimeTypeInfo([this._bodyBytes], type$.JSArray_legacy_List_legacy_int), type$.legacy_List_legacy_int));
    },
  ...
  U.Response.prototype = {
    get$body: function(_) {
      return B.encodingForCharset(U._contentTypeForHeaders(this.headers).parameters._map.$index(0, "charset")).decode$1(this.bodyBytes);
    }
  };
  ...
  U.Highlighter.prototype = {
    highlight$0: function() {
      var highlightsByColumn, t2, t3, i, line, lastLine, t4, t5, t6, t7, t8, cur, t9, index, primaryIdx, primary, _i, _this = this,
        t1 = _this._lines;
      ...
      for (t2 = _this._buffer, t3 = _this._primaryColor, i = 0; i < t1.length; ++i) {
        line = t1[i];
        if (i > 0) {
          lastLine = t1[i - 1];
          t4 = lastLine.url;
        ...
        for (t4 = line.highlights, t5 = H._arrayInstanceType(t4)._eval$1("ReversedListIterable<1>"), t6 = new H.ReversedListIterable(t4, t5), t5 = new H.ListIterator(t6, t6.get$length(t6), t5._eval$1("ListIterator<ListIterable.E>")), t6 = line.number, t7 = line.text, t8 = J.getInterceptor$s(t7); t5.moveNext$0();) {
          cur = t5.__internal$_current;
          t9 = cur.span;
          if (t9.get$start().get$line() != t9.get$end().get$line() && t9.get$start().get$line() === t6 && _this._isOnlyWhitespace$1(t8.substring$2(t7, 0, t9.get$start().get$column()))) {
            ...
            C.JSArray_methods.$indexSet(highlightsByColumn, index, cur);
          }
        }
        ...
        if (highlightsByColumn.length !== 0)
          t2._contents += " ";
        primaryIdx = C.JSArray_methods.indexWhere$1(t4, new U.Highlighter_highlight_closure());
        if (primaryIdx === -1)
          primary = null;
        else {
          if (primaryIdx < 0 || primaryIdx >= t4.length)
            return H.ioore(t4, primaryIdx);
          primary = t4[primaryIdx];
        }
        t5 = primary != null;
        if (t5) {
          t8 = primary.span;
          t9 = t8.get$start().get$line() === t6 ? t8.get$start().get$column() : 0;
          _this._writeHighlightedText$4$color(t7, t9, t8.get$end().get$line() === t6 ? t8.get$end().get$column() : t7.length, t3);
        } else
          _this._writeText$1(t7);
        t2._contents += "\n";
        if (t5)
  ...
  E.TypedDataBuffer.prototype = {
    ...
    addAll$1: function(_, values) {
      H._instanceType(this)._eval$1("Iterable<TypedDataBuffer.E>")._as(values);
      P.RangeError_checkNotNegative(0, "start");
    ...
    setRange$4: function(_, start, end, source, skipCount) {
      ...
      if (end > t2)
        throw H.wrapException(P.RangeError$range(end, 0, t2, null, null));
      t2 = this._typed_buffer$_buffer;
      if (t1._eval$1("TypedDataBuffer<TypedDataBuffer.E>")._is(source))
        C.NativeUint8List_methods.setRange$4(t2, start, end, source._typed_buffer$_buffer, skipCount);
      else
  ...
  (function aliases() {
    ...
    _ = Z.DelegatingClient.prototype;
    _.super$DelegatingClient$close = _.close$0;
    _ = E.BaseClient.prototype;
    _.super$BaseClient$close = _.close$0;
  ...
  (function installTearOffs() {
    ...
    _static_2(P, "async___nullErrorHandler$closure", "_nullErrorHandler", 4);
    _static_0(P, "async___nullDoneHandler$closure", "_nullDoneHandler", 1);
    _instance(P._Completer.prototype, "get$completeError", 0, 1, null, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 50, 0);
    ...
    _static_1(P, "collection___defaultHashCode$closure", "_defaultHashCode", 7);
    ...
    _static_1(P, "core__identityHashCode$closure", "identityHashCode", 7);
    _static_2(P, "core__identical$closure", "identical", 23);
    _static_1(P, "core_Uri_decodeComponent$closure", "Uri_decodeComponent", 65);
    _instance_2_i(W.HttpRequest.prototype, "get$setRequestHeader", "setRequestHeader$2", 27);
    _static(P, "math__max$closure", 2, null, ["call$1$2", "call$2"], ["max", function(a, b) {
      return P.max(a, b, type$.num);
    }], 66, 0);
    _static_1(B, "utils__parseValue$closure", "parseValue", 67);
    _static_1(B, "utils__gridSheetsFilter$closure", "gridSheetsFilter", 45);
  })();
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, P.Error, P._ListBase_Object_ListMixin, P.Iterable, H.ListIterator, P.Iterator, H.ExpandIterator, H.EmptyIterator, H.WhereTypeIterator, H.FixedLengthListMixin, H.UnmodifiableListMixin, H.ConstantMap, H.Closure, H.TypeErrorDecoder, H.NullThrownFromJavaScriptException, H.ExceptionAndStackTrace, H._StackTrace, P.MapMixin, H.LinkedHashMapCell, H.LinkedHashMapKeyIterator, H.JSSyntaxRegExp, H._MatchImplementation, H._AllMatchesIterator, H.StringMatch, H._StringAllMatchesIterator, H.Rti, H._FunctionParameters, H._Type, P._TimerImpl, P._AsyncAwaitCompleter, P._IterationMarker, P._SyncStarIterator, P._BroadcastStreamController, P._Completer, P._FutureListener, P._Future, P._AsyncCallbackEntry, P.Stream, P.StreamSubscription, P.StreamTransformerBase, P._BufferingStreamSubscription, P._PendingEvents, P._DelayedEvent, P._DelayedDone, P._StreamIterator, P._EventSinkWrapper, P.AsyncError, P._Zone, P._SetBase, P._LinkedHashSetCell, P._LinkedHashSetIterator, P.ListMixin, P._UnmodifiableMapMixin, P.MapView, P.StringConversionSinkMixin, P.Codec, P.ChunkedConversionSink, P._Base64Encoder, P._Base64Decoder, P._ConverterStreamEventSink, P._JsonStringifier, P._StringConversionSinkAsStringSinkAdapter, P._Utf8Encoder, P._Utf8Decoder, P._BigIntImpl, P.DateTime, P.OutOfMemoryError, P.StackOverflowError, P._Exception, P.FormatException, P.IntegerDivisionByZeroException, P.Null, P.Sink, P._StringStackTrace, P.StringBuffer, P._Uri, P.UriData, P._SimpleUri, W.EventStreamProvider, P._AcceptStructuredClone, P.Endian, M.CanonicalizedMap, U.DefaultEquality, U.ListEquality, B.Pair, B.Digest, G.HashSink, B.AccessToken, B.AccessCredentials, B.ClientId, B.ServiceAccountCredentials, B.AccessDeniedException, E.BaseClient, U.ASN1Object, Z.RSAPrivateKey, Q.RS256Signer, G.BaseRequest, G.JwtFlow, Y.GSheetsException, Y.GSheets, Y.ValueRenderOption, Y.ValueInputOption, Y.Spreadsheet, Y.Worksheet, Y.WorksheetAsValues, T.BaseResponse, E.ClientException, R.MediaType, M.Context, O.Style, X.ParsedPath, X.PathException, Y.SourceFile, D.SourceLocationMixin, Y.SourceSpanMixin, U.Highlighter, U._Highlight, U._Line, V.SourceLocation, G.SourceSpanException, X.StringScanner]);
    ...
    _inheritMany(H.NativeTypedArrayOfInt, [H.NativeInt8List, H.NativeUint16List, H.NativeUint32List, H.NativeUint8List]);
    ...
    _inheritMany(P.Stream, [P.StreamView, P._StreamImpl, P._BoundSinkStream, W._EventStream]);
    ...
    _inherit(P._SinkTransformerStreamSubscription, P._BufferingStreamSubscription);
    ...
    _inheritMany(P.StringConversionSinkBase, [P._StringSinkConversionSink, P._UnicodeSubsetEncoderSink, P._Base64DecoderSink, P._StringAdapterSink]);
    ...
    _inheritMany(P.Converter, [P._UnicodeSubsetEncoder, P._UnicodeSubsetDecoder, P.Base64Encoder, P.Base64Decoder, P.JsonEncoder, P.JsonDecoder, P.Utf8Encoder, P.Utf8Decoder, R.HexEncoder, A.Hash]);
    ...
    _inheritMany(P.ByteConversionSinkBase, [P._ErrorHandlingAsciiDecoderSink, P._SimpleAsciiDecoderSink, P._Base64EncoderSink, P._ByteAdapterSink, P._ByteCallbackSink, P._Latin1DecoderSink, R._HexEncoderSink]);
    ...
    _inherit(V.Sha256, A.Hash);
    _inherit(V._Sha32BitSink, G.HashSink);
    _inherit(V._Sha256Sink, V._Sha32BitSink);
    _inheritMany(E.BaseClient, [Z.DelegatingClient, O.BrowserClient]);
    _inheritMany(Z.DelegatingClient, [O.AutoRefreshDelegatingClient, O.AuthenticatedClient, Z.RefCountedClient]);
    _inherit(D._ServiceAccountClient, O.AutoRefreshDelegatingClient);
    _inheritMany(U.ASN1Object, [U.ASN1Sequence, U.ASN1Integer, U.ASN1OctetString, U.ASN1ObjectIdentifier, U.ASN1Null]);
    _inheritMany(G.BaseRequest, [Z.RequestImpl, O.Request]);
  ...
  var string$ = {
    ...
    https_a: "https://accounts.google.com/o/oauth2/token",
    https_s: "https://sheets.googleapis.com/v4/spreadsheets/"
  };
  var type$ = (function rtii() {
    ...
    return {
      ...
      WhereTypeIterable_Uri: findType("WhereTypeIterable<Uri>"),
      ...
      _SyncBroadcastStreamController_legacy_AccessCredentials: findType("_SyncBroadcastStreamController<AccessCredentials*>"),
      bool: findType("bool"),
      ...
      legacy_ASN1OctetString: findType("ASN1OctetString*"),
      legacy_ASN1Sequence: findType("ASN1Sequence*"),
      legacy_AccessCredentials: findType("AccessCredentials*"),
      legacy_AutoRefreshingAuthClient: findType("AutoRefreshingAuthClient*"),
      legacy_Blob: findType("Blob*"),
      legacy_FormatException: findType("FormatException*"),
      legacy_Future_legacy_AutoRefreshingAuthClient: findType("Future<AutoRefreshingAuthClient*>*"),
      legacy_HttpRequest: findType("HttpRequest*"),
      legacy_List_dynamic: findType("List<@>*"),
      legacy_List_legacy_Map_of_legacy_String_and_dynamic: findType("List<Map<String*,@>*>*"),
      ...
      legacy_Sink_legacy_Digest: findType("Sink<Digest*>*"),
      legacy_Sink_legacy_String: findType("Sink<String*>*"),
      legacy_Spreadsheet: findType("Spreadsheet*"),
      ...
      legacy_Worksheet: findType("Worksheet*"),
...
;
    ...
    C.List_239_191_189 = H.setRuntimeTypeInfo(makeConstList([239, 191, 189]), type$.JSArray_legacy_int);
    C.List_2Vk = H.setRuntimeTypeInfo(makeConstList([0, 0, 32776, 33792, 1, 10240, 0, 0]), type$.JSArray_legacy_int);
    C.List_2Vk0 = H.setRuntimeTypeInfo(makeConstList([6, 9, 96, 134, 72, 1, 101, 3, 4, 2, 1]), type$.JSArray_legacy_int);
    C.List_65533 = H.setRuntimeTypeInfo(makeConstList([65533]), type$.JSArray_legacy_int);
    C.List_6JR = H.setRuntimeTypeInfo(makeConstList([1116352408, 1899447441, 3049323471, 3921009573, 961987163, 1508970993, 2453635748, 2870763221, 3624381080, 310598401, 607225278, 1426881987, 1925078388, 2162078206, 2614888103, 3248222580, 3835390401, 4022224774, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, 2554220882, 2821834349, 2952996808, 3210313671, 3336571891, 3584528711, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, 2177026350, 2456956037, 2730485921, 2820302411, 3259730800, 3345764771, 3516065817, 3600352804, 4094571909, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, 2227730452, 2361852424, 2428436474, 2756734187, 3204031479, 3329325298]), type$.JSArray_legacy_int);
    ...
    C.List_kqK = H.setRuntimeTypeInfo(makeConstList(["https://www.googleapis.com/auth/spreadsheets", "https://www.googleapis.com/auth/drive"]), type$.JSArray_legacy_String);
    ...
    C.Map_empty = new H.ConstantStringMap(0, {}, C.List_empty1, H.findType("ConstantStringMap<@,@>"));
    ...
    C.ValueInputOption_0 = new Y.ValueInputOption();
    C.ValueRenderOption_0 = new Y.ValueRenderOption("ValueRenderOption.formatted_value");
    C.ValueRenderOption_1 = new Y.ValueRenderOption("ValueRenderOption.unformatted_value");
    C.ValueRenderOption_2 = new Y.ValueRenderOption("ValueRenderOption.formula");
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "_Base64Decoder__emptyBuffer", "$get$_Base64Decoder__emptyBuffer", function() {
    ...
    _lazy($, "Endian_host", "$get$Endian_host", function() {
      return P.ByteData_ByteData$view(H.NativeUint16List__create1(H._ensureNativeList(H.setRuntimeTypeInfo([1], type$.JSArray_int))).buffer).getInt8(0) === 1 ? C.C_Endian0 : C.C_Endian;
    });
    _lazyOld($, "sha256", "$get$sha256", function() {
      return new V.Sha256();
    });
    _lazyOld($, "_bigIntFF", "$get$_bigIntFF", function() {
      return P._BigIntImpl__BigIntImpl$from(255);
    });
    _lazyOld($, "_char_a", "$get$_char_a", function() {
      return 65;
    });
